  ...
  return (
    <div className="register-form">
        ...
        <Form onSubmit={ formik.handleSubmit }>
          ...
          name="email"
          type="text"
          placeholder="Correo electronico" icon="mail outline"
          ...
          placeholder="Contraseña" icon={<Icon name={showPassword ? "eye slash" : "eye"} link onClick={onShowHidenPassword} />}
          onChange={ formik.handleChange}
          ...
          error={formik.errors.password}
           ...
           name="username"
           type="text"
           placeholder="¿Como deberiamos llamarte?" icon="user circle outline"
           onChange={ formik.handleChange }
